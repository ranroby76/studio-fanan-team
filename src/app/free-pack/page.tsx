...
export default function FreePackPage() {
  ...
  const logoUrl = logoData?.freePackLogoUrl ? `/images/${logoData.freePackLogoUrl}` : "https://placehold.co/1200x400.png?text=Free+Pack";
    ...
    <div className="container mx-auto px-4">
      <Card className="shadow-xl text-center">
        <CardHeader>
          ...
          <CardTitle className="text-4xl font-headline text-primary">Free Pack</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
