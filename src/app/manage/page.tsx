...
import { PlusCircle, Edit3, Trash2, Settings, Loader2, PackageSearch, AlertTriangle } from 'lucide-react';
    ...
    <div className="animate-fade-in space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-4xl font-headline font-bold text-primary">Manage Products</h1>
        </div>
